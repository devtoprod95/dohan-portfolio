    ...
    <div className="pb-0">
      ...
      <div className="container py-5" style={{ maxWidth: '1000px' }}>
        ...
        <section className="mb-5 pb-4">
          <h2 className="fw-bold mb-4 border-start border-primary border-4 ps-3" style={{ fontSize: 'clamp(1.5rem, 5vw, 2rem)' }}>자기 소개</h2>
          <div className="ps-3">
            <p className="text-secondary mb-4" style={{ textAlign: 'justify', lineHeight: '1.8', fontSize: 'clamp(1rem, 3vw, 1.25rem)' }}>
            ...
            <div className="bg-light p-4 rounded-3 border-start border-primary border-5 mb-4">
              <p className="mb-0 text-dark fw-medium" style={{ fontSize: 'clamp(0.9rem, 2.5vw, 1.1rem)' }}>
        ...
        {/* 3. 기술 스택 섹션 */}
        <section className="mb-5 pb-4">
          <h2 className="fw-bold mb-5 border-start border-primary border-4 ps-3" style={{ fontSize: 'clamp(1.5rem, 5vw, 2rem)' }}>기술 스택</h2>
        ...
        <section className="mb-5 pb-0">
          <h2 className="fw-bold mb-4 mb-md-5 border-start border-primary border-4 ps-3" 
          ...
          <div className="ps-1 ps-md-3">
            {[
              ...
              <div key={index} className="row mb-4 mb-md-5 g-0 g-md-3">
                ...
                <div className="col-md-9 border-start ps-3 ps-md-4">
                  ...
                  <p className="text-secondary mb-0" 
                     style={{ fontSize: 'clamp(0.85rem, 2.5vw, 1rem)', lineHeight: '1.6' }}>
                    {exp.desc}
                  </p>
                </div>
              </div>
